...
public class ModOreGenerator {
    public static final RegistryKey<PlacedFeature> DARKMATTER_ORE_PLACED_KEY = RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(MOD_ID, "darkmatter_ore_gen"));
