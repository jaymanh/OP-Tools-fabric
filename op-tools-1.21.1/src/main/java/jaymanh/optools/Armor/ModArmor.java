...
public class ModArmor {
    ...
    public static final Item DIAMONDIUM_BOOTS = register(new ArmorItem(ModArmorMaterials.DIAMONDIUM, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(ModArmorMaterials.DIAMONDIUM_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "diamondium_helmet");
    ...
    public static final Item DIAMONDILLIUM_BOOTS = register(new ArmorItem(ModArmorMaterials.DIAMONDILLIUM, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(ModArmorMaterials.DIAMONDILLIUM_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.RARE)), "diamondillium_helmet");
